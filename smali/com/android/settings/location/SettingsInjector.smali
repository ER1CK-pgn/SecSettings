...
.method private addServiceSetting(Ljava/util/List;Lcom/android/settings/location/InjectedSetting;)Landroid/preference/Preference;
    ...
    .line 251
    new-instance v2, Lcom/android/settings/users/MePreference;

    iget-object v4, p0, Lcom/android/settings/location/SettingsInjector;->mContext:Landroid/content/Context;

    invoke-direct {v2, v4, v6}, Lcom/android/settings/users/MePreference;-><init>(Landroid/content/Context;Landroid/util/AttributeSet;)V

    .line 252
    .local v2, pref:Landroid/preference/Preference;
    iget-object v4, p2, Lcom/android/settings/location/InjectedSetting;->title:Ljava/lang/String;

    invoke-virtual {v2, v4}, Lcom/android/settings/users/MePreference;->setTitle(Ljava/lang/CharSequence;)V

    .line 253
    const v4, 0x7f090733

    invoke-virtual {v2, v4}, Lcom/android/settings/users/MePreference;->setSummary(I)V
    ...
    invoke-virtual {v2, v0}, Lcom/android/settings/users/MePreference;->setIcon(Landroid/graphics/drawable/Drawable;)V
