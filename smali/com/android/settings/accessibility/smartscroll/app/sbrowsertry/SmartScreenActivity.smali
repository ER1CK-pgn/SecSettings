...
.method protected getMaxScrollOffset()I
    ...
    invoke-virtual {p0, v5}, Lcom/android/settings/accessibility/smartscroll/app/sbrowsertry/SmartScreenActivity;->findViewById(I)Landroid/view/View;
    ...
    invoke-virtual {p0}, Lcom/android/settings/accessibility/smartscroll/app/sbrowsertry/SmartScreenActivity;->getWindowManager()Landroid/view/WindowManager;
    ...
    invoke-virtual {p0}, Lcom/android/settings/accessibility/smartscroll/app/sbrowsertry/SmartScreenActivity;->getResources()Landroid/content/res/Resources;
...
.method public onConfigurationChanged(Landroid/content/res/Configuration;)V
    ...
    invoke-virtual {p0, v9}, Lcom/android/settings/accessibility/smartscroll/app/sbrowsertry/SmartScreenActivity;->findViewById(I)Landroid/view/View;
...
.method public onCreate(Landroid/os/Bundle;)V
    ...
    invoke-virtual {p0}, Lcom/android/settings/accessibility/smartscroll/app/sbrowsertry/SmartScreenActivity;->getBaseContext()Landroid/content/Context;
    ...
    invoke-virtual {p0}, Lcom/android/settings/accessibility/smartscroll/app/sbrowsertry/SmartScreenActivity;->getActionBar()Landroid/app/ActionBar;
    ...
    :cond_0
    invoke-virtual {p0}, Lcom/android/settings/accessibility/smartscroll/app/sbrowsertry/SmartScreenActivity;->getIntent()Landroid/content/Intent;
    ...
    invoke-virtual {p0, v5}, Lcom/android/settings/accessibility/smartscroll/app/sbrowsertry/SmartScreenActivity;->setContentView(I)V

    const v2, 0x7f0b0278

    invoke-virtual {p0, v2}, Lcom/android/settings/accessibility/smartscroll/app/sbrowsertry/SmartScreenActivity;->findViewById(I)Landroid/view/View;
    ...
    invoke-virtual {p0}, Lcom/android/settings/accessibility/smartscroll/app/sbrowsertry/SmartScreenActivity;->getLayoutInflater()Landroid/view/LayoutInflater;
    ...
    invoke-virtual {p0, v2}, Lcom/android/settings/accessibility/smartscroll/app/sbrowsertry/SmartScreenActivity;->setContentView(I)V
    ...
    invoke-virtual {v2, v4}, Landroid/widget/SeekBar;->setMin(I)V
...
.method protected onDestroy()V
    ...
    invoke-virtual {v3}, Lcom/android/settings/accessibility/smartscroll/touchwiz/widget/TwHelpAnimatedDialog;->dismiss()V
    ...
    invoke-virtual {p0, v3}, Lcom/android/settings/accessibility/smartscroll/app/sbrowsertry/SmartScreenActivity;->findViewById(I)Landroid/view/View;
...
.method public onOptionsItemSelected(Landroid/view/MenuItem;)Z
    ...
    :pswitch_0
    invoke-virtual {p0}, Lcom/android/settings/accessibility/smartscroll/app/sbrowsertry/SmartScreenActivity;->finish()V
...
.method protected showDialog(Landroid/view/View;Z)V
    ...
    invoke-virtual {v0}, Lcom/android/settings/accessibility/smartscroll/touchwiz/widget/TwHelpAnimatedDialog;->dismiss()V
    ...
    invoke-virtual {v0, p1}, Lcom/android/settings/accessibility/smartscroll/touchwiz/widget/TwHelpAnimatedDialog;->setContentView(Landroid/view/View;)V
    ...
    invoke-virtual {v0, v1}, Lcom/android/settings/accessibility/smartscroll/touchwiz/widget/TwHelpAnimatedDialog;->setTouchTransparencyMode(Lcom/android/settings/accessibility/smartscroll/touchwiz/widget/TwHelpDialog$TouchMode;)V

    iget-object v0, p0, Lcom/android/settings/accessibility/smartscroll/app/sbrowsertry/SmartScreenActivity;->mHelpDialog2:Lcom/android/settings/accessibility/smartscroll/touchwiz/widget/TwHelpAnimatedDialog;

    invoke-virtual {v0, v2}, Lcom/android/settings/accessibility/smartscroll/touchwiz/widget/TwHelpAnimatedDialog;->setShowWrongInputToast(Z)V

    iget-object v0, p0, Lcom/android/settings/accessibility/smartscroll/app/sbrowsertry/SmartScreenActivity;->mHelpDialog2:Lcom/android/settings/accessibility/smartscroll/touchwiz/widget/TwHelpAnimatedDialog;

    invoke-virtual {v0, p0}, Lcom/android/settings/accessibility/smartscroll/touchwiz/widget/TwHelpAnimatedDialog;->setOwnerActivity(Landroid/app/Activity;)V

    iget-object v0, p0, Lcom/android/settings/accessibility/smartscroll/app/sbrowsertry/SmartScreenActivity;->mHelpDialog2:Lcom/android/settings/accessibility/smartscroll/touchwiz/widget/TwHelpAnimatedDialog;

    invoke-virtual {v0}, Lcom/android/settings/accessibility/smartscroll/touchwiz/widget/TwHelpAnimatedDialog;->show()V
